                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                    ...
                    <div class="absolute inset-0 px-4 sm:px-6">
                      ...
                      <add-new-semester-form
                          ...
                          :form="semesterForm"
                        ></add-new-semester-form>
                      <div v-if="panelComponent === 'AddNewSemesterForm'">
                        <!-- <add-new-class-form
                          @edit-mode="switchMode"
                          @add-another="addAnother"
                          :editMode="editMode"
...
import AddNewSemesterForm from "../../components/forms/AddNewSemesterForm.vue";
import SimpeTable from "../../molecules/SimpeTable.vue";
import PageHeader from "../../molecules/PageHeader.vue";
import { useAdminStore } from "../../stores/admin";
// import SimpeTable from "../../molecules/SimpeTable.vue";
export default {
  name: "SemesterManagerView",
  ...
  data() {
    return {
      ...
      headers: [
        { name: "Semester Name", value: "attributes.semesterName" },
        { name: "Opening Date", value: "attributes.openingDate" },
        { name: "Closing Date", value: "attributes.closingDate" },
        { name: "", value: "action" },
      ],
      classes: [
        {
  ...
  methods: {
    editClass(data) {
      ...
      this.adminStore.semester = data;
      this.open = true;
    },
    async getAllSemesters() {
      this.loading = true;
      const response = await this.adminStore.getAllSemesters();
      if (response === "success") {
        this.loading = false;
      }
    },
  ...
  computed: {
    allSemesters() {
      return this.adminStore.allSemesters;
    },
  },
  created() {
